...
## Document submitions
Users connect their wallet to begin the siging process
![zKYC Macro Architecture](/images/WalletConnect.png)## Document submitions
After the user connect their wallet the can create the signature
