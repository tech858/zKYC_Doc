...
For the full programmatic integration, see the [Python SDK](/docs/integration/03-agent-sdk).
...
5. Enter an agent name — the on-chain agent ID is derived from your wallet + name combination
